...
const VAPID_PUBLIC_KEY =
  import.meta.env.VITE_VAPID_PUBLIC_KEY || 'BO3Epvi-d_2kfqW3cpA6DYdPYRHdvrdUyV9SMCAVLgSPwHCUcGes6DYjEr6-_3uTQTXq0HY0kI_gK8TVdhDhx-4';
...
export const subscribeToPwaChanges = (listener: () => void): (() => void) => {
...
export const promptHireUpInstall = async () => {
  if (!deferredInstallPrompt) return { outcome: 'unavailable' as const };
